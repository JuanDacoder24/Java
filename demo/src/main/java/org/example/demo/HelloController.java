...
public class HelloController implements Initializable {
    ...
    private final SQLAcces sqlAcces = new SQLAcces();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // Inicializamos la lista de paneles para un cambio de vista más eficiente
        todosLosPaneles = List.of(PanelBotones, PanelMascota, PanelPropietario, PanelConsulta, PanelBuscarMascotas);
        selectPanelVisible(PanelBotones); // Panel inicial
        ...
        // Listener de la Lista de Mascotas
        ...
        // Celda personalizada de la lista
    ...
    @FXML private void BotonRegistrarMascota() { selectPanelVisible(PanelMascota); }
    @FXML private void BotonVolver() { selectPanelVisible(PanelBotones); }
    @FXML private void BotonRegistrarPropietario() { selectPanelVisible(PanelPropietario); }
    @FXML private void BotonRegistrarConsulta() { selectPanelVisible(PanelConsulta); }
    @FXML private void BotonListaMascotas() {
        selectPanelVisible(PanelBuscarMascotas);
        cargarListaMascotas(); // Refresca al entrar
    }
    ...
    private void RegistrarMascota() {
        ...
        try {
            ...
            // Verificar si el dueño existe realmente
    ...
    private void RegistrarPropietario() {
        ...
        try {
            ...
            showError("Error", "Error al guardar el propietario en la base de datos.");
            e.printStackTrace();
        }
    }
    ...
    private void RegistrarConsulta() {
        ...
        try {
            ...
            // Limpieza de campos opcional aquí
        ...
        if (pasaporte.isEmpty()) {
            ...
            try {
                ...
                if (m == null) {
                    ...
                    ListaMascotas.getSelectionModel().select(m); // Selecciona automáticamente en la lista
                }
            } catch (SQLException e) {
    ...
    private void ActualizarCampos() {
        ...
        try {
            ...
            cargarListaMascotas(); // Recargar la lista visual
